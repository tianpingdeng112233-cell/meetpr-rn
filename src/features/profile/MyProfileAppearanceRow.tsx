...
export function MyProfileAppearanceRow() {
  ...
  return <View accessibilityLabel={t('student.appearancePreferenceRow.copy002', [t(`designSystem.appearance.${appearance}`)])} style={{ paddingHorizontal: 16, paddingVertical: 14, minHeight: 68, flexDirection: 'row', alignItems: 'center', gap: 12 }}>
    ...
    <View style={{ flexDirection: 'row', gap: 6 }}>{(['system', 'light', 'dark'] as Appearance[]).map((value) => {
