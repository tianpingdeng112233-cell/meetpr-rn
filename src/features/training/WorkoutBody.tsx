...
function statusMark(draft: WorkoutSetDraft, colors: Colors): { mark: string; color: string } {
  if (draft.status === 'complete') return { mark: '✓', color: colors.success };
  if (draft.status === 'failed') return { mark: '✗', color: colors.gold500 };
  return { mark: '○', color: colors.textTertiary };
}
...
const createStyles = (colors: Colors) => StyleSheet.create({
  ...
  eyebrow: { color: colors.textSecondary, ...typography.monoLabel },
  heroNumbers: { alignItems: 'flex-end', flexDirection: 'row', gap: spacing.sm },
  heroValue: { color: colors.textPrimary, ...typography.displayNumeral },
  unit: { color: colors.textSecondary, textAlign: 'center', ...typography.displayUnit },
  multiply: { color: colors.textTertiary, fontSize: 32, marginBottom: 24 },
  rpeBlock: { marginBottom: 5, marginLeft: 'auto' },
  rpeLabel: { color: colors.textTertiary, ...typography.caption },
  rpeHero: { color: colors.textPrimary, ...typography.title2 },
  ...
  note: { color: colors.textSecondary, ...typography.footnote },
  ...
  exerciseTitle: { color: colors.textPrimary, ...typography.headline },
  exerciseMeta: { color: colors.textTertiary, marginTop: spacing.xs, ...typography.caption },
  tableHeader: { borderBottomColor: colors.borderDefault, borderBottomWidth: StyleSheet.hairlineWidth, flexDirection: 'row', paddingHorizontal: spacing.base, paddingVertical: spacing.sm },
  row: { alignItems: 'center', borderBottomColor: colors.borderDefault, borderBottomWidth: StyleSheet.hairlineWidth, flexDirection: 'row', minHeight: 48, paddingHorizontal: spacing.base },
  rowPressed: { backgroundColor: colors.bgInset },
  numberColumn: { color: colors.textSecondary, width: 28, ...typography.footnote },
  column: { color: colors.textPrimary, flex: 1, textAlign: 'center', ...typography.footnote },
  statusColumn: { alignItems: 'center', flexDirection: 'row', gap: 3, justifyContent: 'flex-end', width: 43 },
  status: { ...font.body(18, 'bold') },
  reference: { color: colors.textTertiary, paddingBottom: spacing.md, paddingHorizontal: spacing.base, ...typography.caption },
});
